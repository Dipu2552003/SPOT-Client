    ...
    <div>
      <div class="list-group" style={well}>
        ...
        <div class="backcontentofheaderside list-group-item flex-column align-items-start">
          <a href="#questions">
            ...
            <small class="text-muted">Whats your name ?</small>
          </a>
          <br />
          <br />
          <a href="#questions">
            ...
            <small class="text-muted">
              Whats your college name where you are studying ?
            </small>
          </a>
          <br />
          <br />
          <a href="#questions">
            ...
            <small class="text-muted">Where are you from ?</small>
          </a>
          <br />
          <br />
          <a href="#questions">
            <i class="fas fa-comment-alt"></i>
            <small class="text-muted">
              Where are the statue of liberty situated ?
            </small>
          </a>
          <br />
        </div>
        ...
        <div class="backcontentofheaderside list-group-item flex-column align-items-start">
          <a href="#questions">
            <i class="fas fa-pencil-alt"></i>
            <small class="text-muted">Changing initializer-list tag wiki</small>
          </a>
          <br />
          <br />
          <a href="#questions">
      ...
      <div class="list-group secondsidefeature" style={well}>
        ...
        <div class="anchorsideheadersecondanswer list-group-item flex-column align-items-start">
          <a href="#questions">
            ...
            <small class="text-muted">Create your custom filter.</small>
          </a>
        </div>
      </div>
      ...
      <div class="list-group secondsidefeature" style={well}>
        ...
        <div class="justify-content-center d-flex list-group-item">
          <a
            href="#questions"
            class="btn anchorsideheadersecondanswerbtn border-secondary"
          >
            <small class="text-muted">Add an ignored tag</small>
          </a>
        </div>
      </div>
    </div>
