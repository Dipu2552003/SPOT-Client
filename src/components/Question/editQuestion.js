...
const EditQuestion = (props) => {
  ...
  useEffect(() => {
    setQheader(questionHeader);
    setQtags(questionTags);
    setQbody(questionBody);
    setMarkdownContent(questionBody);
    setQid(questionId);
  }, [questionHeader, questionTags, questionBody, questionId]);
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="askquestionmodal">
              <i class="fab fa-stack-overflow"></i>&nbsp;&nbsp;Edit Your
              Question
            </h5>
            <button
              type="button"
          ...
          <div class="modal-body">
            <form>
              <div class="mb-3">
                <label for="editQuestion-header" class="col-form-label">
                  Question Header
                </label>
                <input
                  type="text"
                  value={qheader}
                  onChange={editQHeader}
                  class="form-control"
                  placeholder="Type A Question Header..."
                  id="editQuestion-header"
                  name="editQuestion-header"
                />
              </div>
              <div class="mb-3">
                <label for="editQuestion-tags" class="col-form-label">
                  Question Tags
                </label>
                <input
                  type="text"
                  ...
                  id="editQuestion-tags"
                  name="editQuestion-tags"
                />
              </div>
              <div class="mb-3">
                <label for="editQuestion-body" class="col-form-label">
                  Question Body
                </label>
                <textarea
                  value={qbody}
                  ...
                  id="editQuestion-body"
                  name="editQuestion-body"
                ></textarea>
              </div>
              {markdownContent && (
